 ...
 */
/**
 * Every monday.com node executor — the PHP twin of `MONDAY_RUNNABLE_KINDS` in
 * @particle-academy/monday-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `MondayFlow::register($kinds, $executors)` — one call, no directory scan.
